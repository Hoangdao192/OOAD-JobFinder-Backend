...
INSERT INTO company (user_id, company_description, company_name, number_of_employee, address_id) VALUES
...
', 'Công ty Cổ phần viễn thông FPT', '5000+', 1);
...
- Chi nhánh HCM: Tầng 4, tòa nhà Paxsky3, số 225 Bis Đường Nam Kỳ Khởi Nghĩa, Phường 7, Quận 3, TP Hồ Chí Minh.',
     'Công ty cổ phần Hạ tầng Viễn thông CMC Telecom', '1000', 2);
...
10 Đối với doanh nghiệp, lợi nhuận là vô cùng quan trọng, tuy nhiên AMELA sẵn',
     'CÔNG TY CỔ PHẦN CÔNG NGHỆ AMELA VIỆT NAM', '500', 3);

INSERT INTO address (id, detail_address, district, province, ward) VALUES
    (4, 'Hapulico Complex, Center Building, Số 1 Nguyễn Huy Tưởng', 'Thanh Xuân', 'Hà Nội', 'Thanh Xuân Trung');
INSERT INTO company (user_id, company_description, company_name, number_of_employee, address_id)
...
INSERT INTO candidate (user_id, contact_email, date_of_birth, full_name, phone_number, self_description, sex) VALUES
    (6, 'nguyendanghoangdao2002@gmail.com', '2002-02-19', 'Nguyễn Đăng Hoàng Đạo', '0325135251',
     'Sinh viên Trường đại học Công nghệ - Đại học Quốc Gia Hà Nội', 'Male');
INSERT INTO candidate (user_id, contact_email, date_of_birth, full_name, phone_number, self_description, sex) VALUES
    (7, 'nguyenthithanhhuyen2002@gmail.com', '2002-02-20', 'Nguyễn Thị Thanh Huyền', '0325135251',
     'Sinh viên Trường đại học Công nghệ - Đại học Quốc Gia Hà Nội', 'Female');
INSERT INTO candidate (user_id, contact_email, date_of_birth, full_name, phone_number, self_description, sex) VALUES
    (8, 'tranthikimbac2002@gmail.com', '2002-02-21', 'Trần Thị Kim Bắc', '0325135251',
     'Sinh viên Trường đại học Công nghệ - Đại học Quốc Gia Hà Nội', 'Female');
INSERT INTO candidate (user_id, contact_email, date_of_birth, full_name, phone_number, self_description, sex) VALUES
    (9, 'trandinhcuong2002@gmail.com', '2002-02-22', 'Trần Đình Cường', '0325135251',
     'Sinh viên Trường đại học Công nghệ - Đại học Quốc Gia Hà Nội', 'Male');
INSERT INTO candidate (user_id, contact_email, date_of_birth, full_name, phone_number, self_description, sex) VALUES
    (10, 'phanvantiendung2002@gmail.com', '2002-02-23', 'Phan Văn Tiến Dũng', '0325135251',
     'Sinh viên Trường đại học Công nghệ - Đại học Quốc Gia Hà Nội', 'Male');
...
/*Job application*/
INSERT INTO job_application (id, applied_date, status, candidate_user_id, job_id)
VALUES (1, '2023-02-03', 'Waiting', 6, 1),
       (2, '2023-02-03', 'Waiting', 7, 1),
       (3, '2023-02-03', 'Waiting', 8, 1),
       (4, '2023-02-03', 'Waiting', 9, 1),
       (5, '2023-02-03', 'Waiting', 7, 2),
       (6, '2023-02-03', 'Waiting', 8, 2),
       (7, '2023-02-03', 'Waiting', 9, 2),
       (8, '2023-02-03', 'Waiting', 10, 2),
       (9, '2023-02-03', 'Waiting', 8, 3),
       (10, '2023-02-03', 'Waiting', 9, 3),
       (11, '2023-02-03', 'Waiting', 10, 3),
       (12, '2023-02-03', 'Waiting', 6, 3),
       (13, '2023-02-03', 'Waiting', 9, 4),
       (14, '2023-02-03', 'Waiting', 10, 4),
       (15, '2023-02-03', 'Waiting', 6, 4),
       (16, '2023-02-03', 'Waiting', 7, 4),
       (17, '2023-02-03', 'Waiting', 10, 5),
       (18, '2023-02-03', 'Waiting', 6, 5),
       (19, '2023-02-03', 'Waiting', 7, 5),
       (20, '2023-02-03', 'Waiting', 8, 5),
       (21, '2023-02-03', 'Waiting', 6, 6),
       (22, '2023-02-03', 'Waiting', 7, 6),
